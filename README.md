...
and there is a change in architecture in which the whole application will be converted into an Android app using kivy... 
the LLM model will be changed to quen 0.5 billion parameter model and the overall architecture will be changed soon
